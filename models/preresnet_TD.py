...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, gamma=0.5, alpha=0.5, block_size=16):
        ...
        self.conv1 = conv3x3_td(inplanes, planes, stride)
        self.bn2 = nn.BatchNorm2d(planes)
        # self.conv2 = conv3x3(planes, planes)
        self.conv2 = conv3x3_td(planes, planes)
...
class PreResNet(nn.Module):
    ...
    def __init__(self, num_classes=10, depth=110, gamma=0.5, alpha=0.5, block_size=16):
